 ...
 *
 * Sequenzielle Berechnung (im Main-Thread) mit nicht Thread-safe Random
 *
 * @author Sandro Leuchter
 *
 */
class MonteCarloPiSeqThreadLocal {

	static int in = 0;
	static int out = 0;
	final static ThreadLocalRandom r = ThreadLocalRandom.current();
